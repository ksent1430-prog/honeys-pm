    ...
    <div className="flex flex-col">
      <section className="py-20 bg-slate-50 border-b">
        <div className="container px-4 md:px-6 mx-auto text-center">
          ...
          <p className="max-w-[800px] text-muted-foreground text-lg md:text-xl mx-auto leading-relaxed">
            Reliable, 24/7 maintenance for your properties.
          </p>
          <div className="mt-10">
      ...
      <section className="py-20 container px-4 md:px-6 mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-6">Why Choose Our Maintenance Services?</h2>
            <p className="text-muted-foreground text-lg mb-8">
              We provide professional, reliable, and transparent maintenance tailored to the needs of property owners and managers.
            </p>
          ...
          <div className="bg-slate-100 aspect-square rounded-2xl flex items-center justify-center">
            <span className="text-muted-foreground">Illustration for Maintenance Services</span>
          </div>
        </div>
      </section>
    </div>
